...
public class defaultQuizzTests {

    @Test
    public void testDefaultQuizz() {
        ...
        // Create a defaultQuizz instance for testing
        User author = new User(1, "testuser", "password", "John", "Doe", false);
        defaultQuizz quizz = new defaultQuizz(1, "Test Quizz", author, questions, new ArrayList<>());
